...
class Tabs extends Component {
  state = {
    categoryTabId: tabsList[0].tabId,
    randomThumbnail: imagesList[0].imageUrl,
    score: 0,
    timer: 60,
    isGameOver: false,
    isActive: false,
  ...
  render() {
    ...
    const filteredImagesList = imagesList.filter(
      each => each.category === categoryTabId,
    )
      ...
      <div className="tab-bg">
        <nav className="header-bg">
          ...
          <ul className="score-timer-container">
            <li className="score-para">
              <p>
                Score: <span className="span-item">{score}</span>
              </p>
            </li>
        ...
        {!isGameOver && (
          <div className="main-container">
            <div className="tabs-name-container">
              <img src={randomThumbnail} alt="match" className="matchImage" />
                ...
                <ul className="tab-item">
                  {tabsList.map(each => (
                    <TabItem
                      ...
                      isActive={each.tabId === categoryTabId}
                    />
                  ))}
                </ul>
              </div>
